...
#GUI Variables
$FormTitleText = "ജിം ടൈലറുടെ (PowerShellEngineer.com) ഡിസ്ക് ക്ലീനർ"
$SelectDiskLabelText = "ഡിസ്ക് തിരഞ്ഞെടുക്കുക:"
$FreeSpaceLabelText = "ഫ്രീ സ്പേസ് (ജിഗാബൈറ്റുകൾ): "
$TotalSpaceLabelText = "മൊത്തം സ്ഥലം (ജിഗാബൈറ്റുകൾ): "
$JunkFoundLabelText = "ജങ്ക് കണ്ടെത്തി (ജിഗാബൈറ്റുകൾ):"
$CleanDiskBtnText = "ഡിസ്ക് വൃത്തിയാക്കുക *ഫയലുകൾ ഇല്ലാതാക്കുക*"
$SpaceCleanedLabelText = "വൃത്തിയാക്കിയ സ്ഥലം (ജിഗാബൈറ്റുകൾ): "
$LogFileLabelText = "ലോഗ് ഫയൽ കണ്ടെത്തി: $abcdefg"
$CreditLabelText = "ജിം ടൈലറുടെ സ്ക്രിപ്റ്റ് - PowerShellEngineer.com"
$LogFileLocatedText = "ലോഗ് ഫയൽ കണ്ടെത്തി"
$AnalyzingDriveText = "ഡ്രൈവുകൾ വിശകലനം ചെയ്യുന്നു..."
$BrowsersAreRunningText = "ബ്രൗസറുകൾ പ്രവർത്തിക്കുന്നു... ഉപയോക്താവിനെ അറിയിക്കുക..."
$PleaseCloseBrowsersText = "ദയവായി എല്ലാ വെബ് ബ്രൗസറുകളും അടച്ച് വീണ്ടും ശ്രമിക്കുക."
$CleaningDriveText = "ഡ്രൈവ് വൃത്തിയാക്കുന്നു..."
